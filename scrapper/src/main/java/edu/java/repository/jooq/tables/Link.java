...
import edu.java.repository.jooq.Public;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>public.link.type</code>.
     */
    public final TableField<LinkRecord, String> TYPE =
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECKED_AT =
        createField(DSL.name("last_checked_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Long, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from
    ) {
