...
public class KafkaUpdateSenderTest extends IntegrationEnvironment {
    @Autowired
    private KafkaTemplate<String, UpdateLink> kafkaTemplate;
    ...
    public void sendUpdate_shouldSendUpdateInKafka() {
        ...
        var linkUpdate = new UpdateLink(
            1L,
            URI.create("http://google.com"),
            "test",
            List.of(1L)
        );
        var kafkaConsumer = new KafkaConsumer<String, UpdateLink>(
            Map.of(
                ...
                "spring.json.value.default.type", "edu.java.dto.UpdateLink",
